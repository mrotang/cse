        ...
        for (var d in c)
            if (Object.prototype.hasOwnProperty.call(c, d)) {
                ...
                for (var t = 0; t < e.length; t++) {
                    var D = e[t];
                    null != D && (b || (b = a),
                    b += (b.length > a.length ? "&" : "") + encodeURIComponent(d) + "=" + encodeURIComponent(String(D)))
                }
            }
        return b
    }
...
*/
    ...
    window.__gcse.scb = function() {
        ...
        google.search.cse.element.init(opts_) && ("explicit" !== a.parsetags ? "complete" === document.readyState || "interactive" === document.readyState ? (google.search.cse.element.go(),
        null == b || b()) : google.setOnLoadCallback(function() {
    ...
    function O(a) {
        ...
        a: {
            if (a instanceof p)
                ...
                if (-1 === I.indexOf("stylesheet"))
                    throw Error('TrustedResourceUrl href attribute required with rel="stylesheet"');
                if (a instanceof E)
                    a = a instanceof E && a.constructor === E ? a.g : "type_error:SafeUrl";
                else {
                    c: if (H) {
                        try {
                            var c = new URL(a)
    ...
    "cse_token": "AB-tC_5tIefI1J-jgHIjoY8n8uA1:1724384534380",
    "isHostedPage": false,
    "exp": ["cc"],
